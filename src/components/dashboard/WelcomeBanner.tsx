      ...
      {isDemoMode && (
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-3.5 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-900 dark:text-amber-200">
          <div className="flex items-center gap-2.5">
            <span className="px-2 py-0.5 rounded-full bg-amber-500 text-white text-xs font-bold uppercase tracking-wider">
              Modo Demonstração
            </span>
            <p className="text-xs sm:text-sm font-medium">
              Você está explorando uma demonstração pública interativa com dados fictícios realistas
              de uma farmácia magistral.
            </p>
          </div>
          <span className="text-xs text-amber-700 dark:text-amber-300 font-mono hidden md:inline">
            Acesso autocontido
          </span>
        </div>
      )}
